...
class 73_60Rnd_762x51_Mag: OPTRE_32Rnd_762x51_Mag{
    displayName="[73] 60Rnd 7.62x51mm Magazine";
    author= "73rd S-4 Team";
    ammo="73_B_762x51_Tracer";
};
class 73_60Rnd_762x51_Mag_Tracer: 73_32Rnd_762x51_Mag{
    displayName="[73] 60Rnd 7.62x51mm Magazine [Tracer]";
    ammo="73_B_762x51_Tracer";
    tracersEvery = 1;
};
class 73_60Rnd_762x51_Mag_Tracer_Yellow: 73_32Rnd_762x51_Mag_Tracer
{
