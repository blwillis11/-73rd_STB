...
class 73_CQS48_Bulldog: OPTRE_CQS48_Bulldog_Automatic
{
    baseWeapon = "73_CQS48_Bulldog"; // Consistent with the classname
    displayName = "[73] CQS-48 Bulldog";
    magazines[] = {"73_24Rnd_12Gauge_Pellets"}; // Requires a magazine to be defined so that the "Impact" slider in the arsenal will have a value. This also defines the standard magazine when the weapon is spawned.
    magazineWell[]={"73_shotgun_Bulldog"};
    author= "73rd S-4 Team";
    class WeaponSlotsInfo: WeaponSlotsInfo
    {
     class MuzzleSlot: MuzzleSlot
...
class 73_CQS48S_Chihuahua: OPTRE_CQS48S_Chihuahua_Automatic
{
    baseWeapon = "73_CQS48S_Chihuahua"; // Consistent with the classname
    displayName = "[73] CQS-48S Chihuahua";
    magazines[] = {"73_24Rnd_12Gauge_Pellets"}; // Requires a magazine to be defined so that the "Impact" slider in the arsenal will have a value. This also defines the standard magazine when the weapon is spawned.
    magazineWell[]={"73_shotgun_Bulldog"};
    author= "73rd S-4 Team";
    class WeaponSlotsInfo: WeaponSlotsInfo
