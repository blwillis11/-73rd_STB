            ...
            class t_MA {
                ...
                class Chair_Force {
                    ...
                    class Chair_Force_1 {
                        ...
                        statement = "0 = [0,0,300,1,400] spawn STB73_fnc_setRadio73STB;";
                        condition = "true";
                    };
                    class Chair_Force_2 {
                        displayName = "Air Squad 2";
                        statement = "0 = [1,1,300,1,400] spawn STB73_fnc_setRadio73STB;";
                        condition = "true";
                    };
                };
                ...
                class Arm_frc {
                    ...
                    class Arm_frc_1 {
                        ...
                        statement = "0 = [0,0,300,1,500] spawn STB73_fnc_setRadio73STB;";
                        condition = "true";
                    };
                    class Arm_frc_2 {
                        displayName = "Mech Force 2";
                        statement = "0 = [1,1,300,1,500] spawn STB73_fnc_setRadio73STB;";
                        condition = "true";
                    };
                };
            };
