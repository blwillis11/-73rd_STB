...
class 73_Marine_Marksman: 73_10MEBBase
{
    ...
    linkedItems[] = {"73_CEArmourNSV2","Rogue_CEBoonie","ItemMap","ItemRadio","ItemCompass","ItemWatch","LM_OPCAN_CAMSNI"};
    respawnLinkedItems[] = {"73_CEArmourNSV2","Rogue_CEBoonie","ItemMap","ItemRadio","ItemCompass","ItemWatch","LM_OPCAN_CAMSNI"};
